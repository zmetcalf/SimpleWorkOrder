<div class="col-sm-3 col-md-2 sidebar">
  ...
  <ul class="nav nav-sidebar">
    <li <?php if($slug == 'unassigned-wo') { echo 'class="active"'; } ?>><a href="">Unassigned WO's</a></li>
    <li <?php if($slug == 'assign-wo') { echo 'class="active"'; } ?>><a href="">Assigned WO's</a></li>
    <li <?php if($slug == 'stale-wo') { echo 'class="active"'; } ?>><a href="">Stale Assigned WO's</a></li>
  </ul>
  <ul class="nav nav-sidebar">
