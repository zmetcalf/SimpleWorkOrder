<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
  ...
  <?php echo form_open('work_order/view_wo/' . $record) ?>
  <div class="row">
    ...
    <?php if ($result['assigned_to'] && $is_admin): ?>
      <div class="well col-sm-5 col-sm-offset-1 col-md-5 col-md-offset-1">
        <p>Assigned to: <a href="<?php echo base_url(); ?>user/view_user/<?php echo $result['users_uid']; ?>">
        ...
        <p>Completed by:
          <?php if ($result['completed_by']): ?>
            <?php if ($result['completed_by'] == $result['assigned_to']): ?>
              <a href="<?php echo base_url(); ?>user/view_user/<?php echo $result['users_uid']; ?>">
  ...
  <?php if (!$completed): ?>
    ...
    <?php elseif ($is_admin): ?>
      ...
      <a href="<?php echo base_url() . 'work_order/modify_wo/' . $record; ?>"
